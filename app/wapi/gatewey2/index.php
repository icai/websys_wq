			...
			<div class="we7-form">
				<div class="col-sm-6 we7-padding">
					...
					<div class="form-group">
					  ...
					  <div class="form-controls col-sm-9 ">
						  <input type="text" readonly="readonly" name="url_t" value="https://lanmengkeji.taobao.com/"  class="form-control">
					  </div>
					</div>
				...
				<div class="col-sm-6 we7-padding">
						...
						<div class="form-group">
						  ...
						  <div class="form-controls col-sm-9 ">
							  <input name="contact" type="text" class="form-control"  value="https://lanmengkeji.taobao.com/"  id="contact" readonly="readonly" >
